    ...
    overview: [
      {
        introduction: {
          title: 'Ashiyana',
          imageSrc: '/assets/Ashiyana.jpg',
          content: '',
        },
        location: {
          head: 'LOCATION',
          address:
            'No. 98, Vyasar Street, Kamakshi Nagar, Valasaravakkam, Chennai - 600087',
          locationContent: [
            'Imagine a popular residential site, yearning patiently for decades, profoundly evolve into something grander and attain higher ranking honours. Thats precisely what has materialised with the pioneering intervention of Ashiyana.',
            'This sizeable, noteworthy property right on Kamakshi Nagar, Valasaravakkam is an integral part of an exemplar neighbourhood. It now finally gets the long overdue attention and fitting tribute that it richly deserves.',
          ],
          mapCoordinates: { latitude: 13.045412, longitude: 80.172549 },
        },
        floorPlan: {
          title: 'FLOOR PLAN',
          plans: [
