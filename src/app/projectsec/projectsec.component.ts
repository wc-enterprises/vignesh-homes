...
import { ComingSoonProject } from '../common-utils/project-service';
  ...
  filterProjects(saleTag: string) {
    switch (saleTag) {
      case 'forsale':
        ...
        this.comingSoonProjects = []; // Clear coming soon projects
        break;
      case 'ongoing':
      ...
      case 'comingsoon':
        ...
        this.standardProjects = []; // Clear standard projects
        break;
      default:
        // Handle default case or set a default saleTag
        break;
    }
  }
}
